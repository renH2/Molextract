...
class MoleculeEnv(gym.Env):
    ...
    def init(self, docking_config=dict(), params=dict(), ratios=dict(), reward_step_total=1,
             is_normalize=0, has_scaffold=False, has_feature=False,
             max_action=128, min_action=20, force_final=False, load_cpu=1,
             version="v1"):
        '''
        ...
        self.atom_type_num = len(ATOM_VOCAB)
        self.motif_type_num = len(FRAG_VOCAB)
